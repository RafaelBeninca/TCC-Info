...
const cities = ["Criciúma", "Içara", "Nova Veneza", "Forquilhinha", "Siderópolis", "Cocal do Sul", "Morro da Fumaça", "São Bento Baixo", "Treviso", "Urussanga", "Balneário Rincão", "Torneiro", "Maracajá"]
...
const SelectCity: React.FC = () => {
  ...
  return (
    <div className="flex flex-row text-lg gap-4 mt-5">
      ...
      <select className="h-10 w-60 my-auto border-2 bg-transparent border-primary-dark rounded-md focus:outline-none focus:ring-2 focus:ring-primary-default focus:border-primary-default overflow-y-auto hover:shadow-lg transition-all" value={selectedCity} onChange={handleSelectChange}>
      ...
      {user?.uid == userId && (
      <button className="w-6 h-6 hover:scale-110 transition-all duration-300" onClick={toggleEditable}>
          <svg
