    ...
    const fetchFilteredData = async () => {
      ...
      try {
        ...
        if (priceRange.priceMin && priceRange.priceMax) {
          ...
          q = query(q, where("value", ">=", min), where("value", "<=", max));
        }
  ...
  return (
    <div className="flex flex-row h-full overflow-hidden">
      <div className="bg-gray-200 flex flex-col items-center justify-center border-r-4 border-primary-default h-full w-2/6">
        <p className="font-bold my-5 text-4xl text-center">
          Filtros de pesquisa:
        </p>

        <div className="w-full mb-5">
          <p className="ml-3 font-semibold text-primary-default">
            Filtro por Título:
          </p>
          <input
        ...
        <div className="w-full px-24 mb-3">
          ...
          <button
            className={`w-full h-10 rounded-lg hover:scale-105 transition-all duration-300 ${
              order
        ...
        <div className="bg-transparent w-auto mx-6 flex flex-col">
          ...
          <select
            className="h-13 w-full mb-3 my-auto border-2 bg-transparent border-primary-dark rounded-md focus:outline-none focus:ring-2 focus:ring-primary-default focus:border-primary-default overflow-y-auto hover:shadow-lg transition-all"
            value={searchCity}
          ...
          <select
            className="h-13 w-full my-auto border-2 mb-3 bg-transparent border-primary-dark rounded-md focus:outline-none focus:ring-2 focus:ring-primary-default focus:border-primary-default overflow-y-auto hover:shadow-lg transition-all"
            value={searchTag}
          ...
          <div className="flex flex-row">
            <DecimalInput
              ...
              onChange={(e) =>
                handleInputChange<PriceRange>(e, setPriceRange, "priceMin")
              }
            />
        ...
        <button
          className="bg-primary-default hover:bg-primary-dark hover:scale-105 transition-all duration-300 w-1/2 h-12 rounded-lg mt-5"
